...
В текущем исходном коде после релиза 0.1.5 появился экспериментальный переключатель мягкого студийного света и отдельный Scene Core. Он пока не входит в опубликованный установщик 0.1.5. [Архитектура и ограничения](docs/renderer-architecture.md).
