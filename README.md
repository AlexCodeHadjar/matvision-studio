...
**Версия 0.1.7 · Windows x64 · Активная разработка · Приоритет: качество изображения**

[Скачать Windows-версию](https://github.com/AlexCodeHadjar/matvision-studio/releases/tag/v0.1.7) · [Инструкция](docs/USER_GUIDE.md) · [План развития](ROADMAP.md) · [Сравнение с аналогами](docs/COMPARISON.md) · [Сборка](DEVELOPMENT.md)
...
1. Откройте [релиз v0.1.7](https://github.com/AlexCodeHadjar/matvision-studio/releases/tag/v0.1.7), скачайте `MatVisionStudio-0.1.7-x64-setup.exe` и установите программу.
...
Репозиторий содержит исходники 0.1.7, тесты, документацию и ресурсы. Установщик размещается в Releases; Blender, зависимости сборки, кеши и личные проекты в Git не включаются. [Проверка Windows-версии 0.1.7](docs/release/native-quality-0.1.7.json) фиксирует реальные прогоны Photo и Cycles prototype; [матрица рендереров](docs/RENDERERS_0.1.7.md) перечисляет ещё не реализованный перенос и калибровку. Отдельная лицензия собственного кода ещё не оформлена; лицензии зависимостей сохраняются.
